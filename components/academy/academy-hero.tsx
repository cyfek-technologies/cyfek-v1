...
export function AcademyHero() {
  return (
    <section className="min-h-screen bg-hero-bg pt-20 relative overflow-hidden">
      {/* Animated background */}
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <div className="space-y-8">
            <div className="inline-flex items-center gap-3 px-4 py-2 bg-gradient-to-r from-violet-500/20 to-teal/20 rounded-full border border-violet-500/30">
              ...
              <span className="text-hero-foreground text-sm font-medium">Applications Now Open</span>
            </div>

            <h1 className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-hero-foreground leading-tight">
              Learn Tech Skills{" "}
              <span className="relative inline-block">
                <span className="bg-gradient-to-r from-violet-400 to-teal bg-clip-text text-transparent">For Free</span>
                <svg
                ...
                >
                  <path d="M0 10 Q 50 0, 100 10 Q 150 20, 200 10" stroke="url(#gradient)" strokeWidth="3" fill="none" />
                  <defs>
            ...
            <p className="text-xl text-hero-foreground/70 leading-relaxed max-w-xl">
              A 6-month intensive program where you learn in-demand tech skills, work as an intern at Cyfek, and
              graduate with real-world experience and certification.
            </p>

            <div className="flex flex-wrap gap-6">
              {["100% Free", "Real Projects", "Paid Internship", "Job-Ready"].map((item) => (
                <div key={item} className="flex items-center gap-2 text-hero-foreground/80">
          ...
          <div className="relative">
            ...
            <div className="relative bg-hero-bg/50 backdrop-blur border border-hero-foreground/10 rounded-3xl p-8 space-y-6">
              <div className="flex items-center gap-4 pb-6 border-b border-hero-foreground/10">
                ...
                <div>
                  <h3 className="text-hero-foreground font-semibold">Cyfek Academy</h3>
                  <p className="text-hero-foreground/60 text-sm">Cohort 3 Starting Soon</p>
                </div>
              </div>

              <div className="space-y-4">
                <div className="flex justify-between items-center p-4 bg-hero-foreground/5 rounded-xl">
                  <span className="text-hero-foreground/70 text-sm">Program Duration</span>
                  <span className="text-hero-foreground font-semibold">6 Months</span>
                </div>
                <div className="flex justify-between items-center p-4 bg-hero-foreground/5 rounded-xl">
                ...
                <div className="flex justify-between items-center p-4 bg-hero-foreground/5 rounded-xl">
                  <span className="text-hero-foreground/70 text-sm">Format</span>
                  <span className="text-hero-foreground font-semibold">Hybrid Learning</span>
                </div>
                <div className="flex justify-between items-center p-4 bg-hero-foreground/5 rounded-xl">
                  <span className="text-hero-foreground/70 text-sm">Internship Included</span>
              ...
              <div className="pt-4">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <span className="text-hero-foreground/70 text-sm">+50 students enrolled</span>
                </div>
                ...
                <p className="text-hero-foreground/50 text-xs mt-2">Limited spots remaining</p>
              </div>
            </div>
          </div>
        </div>
