      ...
      <div className="container mx-auto px-4 lg:px-8">
        <div className="flex items-center justify-between h-16 lg:h-20">
            ...
            >
              ...
              {isCompanyOpen && (
                <div className="absolute top-full left-0 mt-2 w-64 bg-hero-bg border border-hero-foreground/10 rounded-xl shadow-xl overflow-hidden">
                  ...
                  >
                    <span className="text-hero-foreground font-medium text-sm">About Us</span>
                    <p className="text-hero-foreground/60 text-xs mt-0.5">Learn about our mission</p>
                  </Link>
                  <Link href="/what-we-do#team" className="block px-4 py-3 hover:bg-teal/10 transition-colors">
                    <span className="text-hero-foreground font-medium text-sm">Our Team</span>
                    <p className="text-hero-foreground/60 text-xs mt-0.5">Meet our leadership</p>
                  </Link>
                </div>
              )}
            </div>
              ...
              {isProductsOpen && (
                <div className="absolute top-full left-0 mt-2 w-64 bg-hero-bg border border-hero-foreground/10 rounded-xl shadow-xl overflow-hidden">
                  <Link
                    ...
                    className="block px-4 py-3 hover:bg-teal/10 transition-colors border-b border-hero-foreground/10"
                  >
                    <span className="text-teal font-semibold text-sm">All Products</span>
                    <p className="text-hero-foreground/60 text-xs mt-0.5">Explore our ecosystem</p>
                  </Link>
                  <a
                  ...
                  >
                    <span className="text-hero-foreground font-medium text-sm">SELTRA</span>
                    <p className="text-hero-foreground/60 text-xs mt-0.5">Peer-to-peer marketing platform</p>
                  </a>
                  <Link href="/academy" className="block px-4 py-3 hover:bg-teal/10 transition-colors">
                    <span className="text-hero-foreground font-medium text-sm">Cyfek Academy</span>
                    <p className="text-hero-foreground/60 text-xs mt-0.5">Free tech education program</p>
                  </Link>
                </div>
              )}
            </div>
          ...
          <div className="hidden lg:block">
            <Button onClick={openContactPopup} className="bg-teal text-navy hover:bg-teal/90 font-semibold px-6">
              Get in Touch
            </Button>
          </div>
