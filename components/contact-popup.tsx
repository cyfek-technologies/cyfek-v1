...
export function ContactPopup({
  ...
  const openWhatsApp = () => {
    ...
    window.open(`https://wa.me/2347082471978?text=${message}`, "_blank");
  };
          ...
          {step === "pricing" && (
            <div className="space-y-6">
              <div className="text-center">
                ...
                <p className="text-muted-foreground">
                  Here's a breakdown of your selected services
                </p>
              </div>
              ...
              <div className="bg-muted rounded-2xl p-6 space-y-4">
                ...
                <div className="border-t border-border pt-4 mt-4">
                  ...
                  <p className="text-xs text-muted-foreground mt-2">
                    *Final pricing may vary based on project scope and
                    requirements
                  </p>
                </div>
              </div>
          ...
          {step === "contact" && isSubmitted && (
            <div className="text-center py-8 space-y-6">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Thanks for reaching out, {formData.name.split(" ")[0]}! We'll
              ...
              <Button
                onClick={onClose}
                className="bg-teal text-navy hover:bg-teal/90 font-semibold px-8"
              >
                Close
              </Button>
            </div>
